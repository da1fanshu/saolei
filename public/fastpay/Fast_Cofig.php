...
define("PAY_VERSION_P", '2.11');//版本
//FAST客户支付配置
define("FAST_APPKEY", "23310_dea50637e1b93f9dc99df830c5eca5ec");//你的appkey
define("SECRET_KEY", "71b628764916d2f6a5391d19666d1e2c");//你的秘钥
...
define("API_WEIXIN_URL", 'http://url.xxx.com/code_url.php?v='.PAY_VERSION);//可动态修改代理二维码内容,被封自动替换,需要联系客服开通

/**----检测域名是否被封---------**/
define("API_WEIXIN_CHECKURL", 'http://url.xxx.com/code_checkurl.php?v='.PAY_VERSION);//检测域名是否被封

/**----从我们后台列表里面检测获取可用域名--轮训自动切换-------**/
define("API_WEIXIN_ADMIN_CHECKURL", 'http://url.xxx.com/code_check_domin.php?v='.PAY_VERSION);//检测域名是否被封
